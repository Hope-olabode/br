...
/* const StyledWrapper = styled.div`
  ...
  .box1 {
    ...
    margin-top: 64px;
    margin-left: 0px;
    animation: abox1 4s 0.1s forwards ease-in-out infinite;
  }
  ...
  .box2 {
    ...
    margin-top: 0px;
    margin-left: 0px;
    animation: abox2 4s 0.1s forwards ease-in-out infinite;
  }
  ...
  .box3 {
    ...
    margin-top: 0px;
    margin-left: 64px;
    animation: abox3 4s 0.1s forwards ease-in-out infinite;
  }
