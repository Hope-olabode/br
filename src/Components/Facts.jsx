export default function Facts() {
  return(
    <div className="grid grid-cols-2 grid-rows-2 gap-y-[40px] px-4 py-[72px] lg:flex flex-row justify-between md:px-[40px] lg:px-[60px] xl:px-[80px] 2xl:px-[120px] text-left">
      ...
      <div className="order-4 sm:text-right flex flex-col gap-2 lg:text-left">
        ...
        <h1 className="font-nexa-light text-[32px] leading-[42px] lg:text-[40px] lg:leading-[56px] 2xl:text-[48px] 2xl:leading-[64px]">+5 years</h1>
      </div>
